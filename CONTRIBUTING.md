# Contributing to Slideshow Plugin

First, thank you for your contributions! This is very appreciated :)

**Please create any Pull-Request on the `dev` branch instead of the `master` branch!**

## Reporting a bug

If you have found a bug in this plugin, the best place to report it is with the [Slideshow plugin official repository](https://github.com/flo-sch/slideshow-plugin/issues).
...
- **Expected result**: How the plugin should behave on above mentioned steps.
...
2. Please make your fix on the `dev` branch. This makes merging much easier.
...
We follow The October team [developer guidelines](http://octobercms.com/docs/help/developer-guide) as much as possible, and of course the [Laravel contributions guidelines](https://laravel.com/docs/master/contributions).